...
Проект посвящен предсказанию будущих продаж товаров в различных магазинах, расположенных в различных регионах, на основе исторических данныx. Особенностью данных являлось большое количество нолей и пропусков в данных, а также тяжеловестность данных, требующяя больших вычислительных мощностей для работы с ними.
